...
Horseman.prototype.pageMaker = function(_page) {
	...
	function setupPage(page) {
		...
		page.onPageCreated = function(newPage) {
			self.ready = self.pageMaker(newPage)
				.tap(function() {
		...
		function loadFinishedSetup() {
			var args = arguments;
			self.pageCnt++;
			debug('phantomjs onLoadFinished triggered', self.pageCnt);

			self.ready = self.ready.then(function injectJQuery() {
